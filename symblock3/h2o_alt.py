...
def water_mp2_script(scfwfn, mints):
  ...
  e = tn.Array((ax.Axis((occ_ax, vir_ax), tn.Array),))
  for h in range(nirrep):
    for i in range(naoccpi[h]):
